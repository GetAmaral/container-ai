// ============================================================
// Node: "Expandir Recorrentes" — Code v2 (CORRIGIDO v3)
...
//
// CORREÇÃO v3:
// 4. Adicionado pairedItem: { item: 0 } em TODOS os returns
//    para corrigir crash do Information Extractor1:
//    "Paired item data for item from node 'Expandir Recorrentes'
//     is unavailable"
// ============================================================
...
if (!rangeStart || !rangeEnd) {
  const result = [...normais, ...recorrentes].map((e) => ({ json: e, pairedItem: { item: 0 } }));
  return result.length > 0 ? result : [{ json: {}, pairedItem: { item: 0 } }];
}
...
const result = all.map((e) => ({ json: e, pairedItem: { item: 0 } }));
